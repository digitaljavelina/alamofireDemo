...
//  PhotoTagger
//
//  Created by Michael Henry on 3/7/16.
...
public enum ImaggaRouter: URLRequestConvertible {
  ...
  static let authenticationToken = "Basic YWNjXzk3NDhlY2MxNDk4ZTkzZTpkYjMyNzQ1MjBkOWU3ZTRmYjAyMmFhNDdmNWI5ZTBlYw=="
  ...
  public var URLRequest: NSMutableURLRequest {
    let result: (path: String, method: Alamofire.Method, parameters: [String: AnyObject]) = {
      ...
      case .Colors(let contentID):
        let params = ["content": contentID, "extract_image_colors": NSNumber(int: 0)]
